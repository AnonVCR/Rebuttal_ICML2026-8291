...
**Figure A: Correlation between Representation Shift and Ground Truth Probability Drop.** The larger the discrepancy between **emb** and **emb'**, the greater the performance drop.
